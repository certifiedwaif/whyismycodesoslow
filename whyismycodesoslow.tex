...
\begin{frame}{What's coming?}
	\begin{itemize}
		\item Better hardware -- higher core counts, GPUs with more cores \\
			...
			\note{The day will soon come where you routinely use machines with 1000 cores or more. In fact, if you play computer games and have an NVidia GPU, you're already doing this!}
